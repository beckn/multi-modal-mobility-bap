            ...
            <ScrollView>
                ...
                <View style={[WT('100%'), C.bgWhite, L.card]}>
                    ...
                    <View style={[L.even, L.jcSB, L.pH10]}>
                        ...
                        <View style={[L.aiR]}>
                            <Text style={[C.lColor, F.ffM, F.fsOne4]}>Start time <Text style={[F.ffB]}>{moment.utc(ride_updates?.details?.startTime ?? "" ).format('hh:mm A')}</Text></Text>
                            <Text style={[C.lColor, F.ffM, F.fsOne4]}>End time <Text style={[F.ffB]}>{moment.utc(ride_updates?.details?.endTime ?? "" ).format('hh:mm A')}</Text></Text>
                        </View>
                    </View>
                    <View style={[HT(40)]} />
                </View>
